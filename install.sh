...
tar xpvf ./root/boot/grub/themes/SteonsGate.tar.gz --directory=./root/boot/grub/themes
rm --force ./root/boot/grub/themes/SteonsGate.tar.gz
tar xpvf ./root/usr/share/fonts/TTF/*.tar.gz --directory=./root/usr/share/fonts/TTF
rm --force ./root/boot/grub/themes/*.tar.gz
tar xpvf ./root/usr/share/icons/EllenJoe.tar.gz --directory=./root/usr/share/icons
rm --force ./root/usr/share/icons/EllenJoe.tar.gz
