...
wget --directory-prefix=/mnt "https://distfiles.gentoo.org/releases/amd64/autobuilds/current-stage3-amd64-llvm-openrc/$(curl https://distfiles.gentoo.org/releases/amd64/autobuilds/current-stage3-amd64-llvm-openrc/latest-stage3-amd64-llvm-openrc.txt | grep '.tar.xz' | awk '{print $1}')"
...
emerge-webrsync
emerge --sync
emerge --quiet --changed-use --deep @world
emerge --depclean
